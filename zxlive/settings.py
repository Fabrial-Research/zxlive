...
tikz_export_defaults: dict[str, str] = {
    ...
    "tikz/triangle-output-export": 'triangle',
    "tikz/triangle-input-export": 'triangle input',
    "tikz/triangle-inverse-output-export": 'triangle inverse',
    "tikz/triangle-inverse-input-export": 'triangle inverse input',
...
def load_tikz_classes() -> dict[str, str]:
    return {
        ...
        'triangle': str(settings.value('tikz/triangle-output-export', pyzx.settings.tikz_classes['triangle'])),
        'triangle input': str(settings.value('tikz/triangle-input-export', pyzx.settings.tikz_classes['triangle input'])),
        'triangle inverse': str(settings.value('tikz/triangle-inverse-output-export', pyzx.settings.tikz_classes['triangle inverse'])),
        'triangle inverse input': str(settings.value('tikz/triangle-inverse-input-export', pyzx.settings.tikz_classes['triangle inverse input'])),
